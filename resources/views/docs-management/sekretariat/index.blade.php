            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Surat Masuk Bidang Sekretariat</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
@section('main-content')
    <div class="card">
        ...
        <div class="card-body">
            @php
                $routingEndpointAlias = [
                    'doc-sekretariat-in.edit',
                    'doc-sekretariat-in.show',
                    'doc-sekretariat-in.destroy',
                ];
            @endphp
